                            ...
                            <div className="container mx-auto px-4 md:px-6 max-w-7xl text-center">
                                <div className="flex flex-col items-center gap-6">
                                    ...
                                    <p className="text-slate-400 max-w-md">
                                        Get a custom solar design and quote in less than 24 hours. No commitment required.
                                    </p>
                                    ...
                                    <div className="mt-12 pt-8 border-t border-slate-800 w-full flex flex-col md:flex-row justify-between items-center text-sm text-slate-500">
                                        <p>© 2023 SolarGreen Inc. All rights reserved.</p>
