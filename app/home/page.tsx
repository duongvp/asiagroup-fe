                    ...
                    <header className="sticky top-0 z-50 w-full bg-white/90 backdrop-blur-md dark:bg-background-dark/90 border-b border-gray-200 dark:border-white/10">
                        <div className="flex items-center justify-between px-6 py-4 max-w-[1280px] mx-auto">
                            <div className="flex items-center gap-3 text-foreground">
                                ...
                                <h2 className="text-xl font-bold leading-tight tracking-tight">Solar Company</h2>
                            </div>
                    ...
                    <section className="w-full bg-brand-blue text-white py-12">
                        <div className="max-w-[1280px] mx-auto px-6">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 divide-y md:divide-y-0 md:divide-x divide-white/10">
                                {[
                                    { icon: 'bolt', value: '500+ MW', label: 'Clean Energy Generated' },
                                    { icon: 'payments', value: '$10M+', label: 'Customer Money Saved' },
                                    { icon: 'groups', value: '5,000+', label: 'Happy Customers' },
                                ].map((stat, index) => (
                        ...
                        <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center gap-2 text-foreground">
                                    ...
                                    <h3 className="text-lg font-bold">Solar Company</h3>
                                </div>
